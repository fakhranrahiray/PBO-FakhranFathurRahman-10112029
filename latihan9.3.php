...
class komputer {
    ...
    // SEBELUMNYA ERROR: Diubah ke protected karena private tidak bisa diakses class laptop (anak)
    ...
    // SEBELUMNYA ERROR: Diubah ke protected karena private tidak bisa dipanggil oleh class laptop
...
class laptop extends komputer{
    ...
    public function display_processor() {
        // ERROR SEBELUMNYA: baris ini error karena $jenis_processor di atas tadinya private
        return $this->jenis_processor;
    }
    ...
    public function display_ram2() {
        // ERROR SEBELUMNYA: baris ini error karena memanggil tampilkan_ram() yang tadinya private
    ...
    // SEBELUMNYA ERROR: Diubah ke public karena dipanggil dari luar class (objek)
...
// ERROR SEBELUMNYA: Baris 67 error karena fungsi display_processorkomputer() tadinya private
