...
<body>
    ...
    <div class="header">
        ...
        <br>
        <br>
            Ketentuan denda keterlambatan 0.15% per
            hari dari angsuran
        </p>

        Keterlambatan Angsuran (Hari): <?php echo $transaksi->keterlambatanHari; ?><br>
        Denda Keterlambatan : <?php echo $transaksi->formatRupiah($transaksi->hitungDenda()); ?> <br>
        Besaran Pembayaran : <?php echo $transaksi->formatRupiah($transaksi->hitungTotalBayar()); ?>
    </div>
